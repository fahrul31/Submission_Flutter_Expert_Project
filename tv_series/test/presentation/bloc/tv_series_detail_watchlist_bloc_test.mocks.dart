...
// in tv_series/test/presentation/bloc/tv_series_detail_watchlist_bloc_test.dart.
...
import 'package:tv_series/utils/failure.dart' as _i7;
...
/// A class which mocks [SaveWatchTvSeries].
///
/// See the documentation for Mockito's code generation for more information.
class MockSaveWatchTvSeries extends _i1.Mock implements _i6.SaveWatchTvSeries {
  MockSaveWatchTvSeries() {
    _i1.throwOnMissingStub(this);
  }
